export const meta = { 
    title: "Keycloak integration into a Java Servlet Application", 
    tags: ["java", "keycloak"], 
...
# Keycloak integration into a Java Servlet application
...
- A Client. It's a representation of your Java application
    ...
    - Access Type: public
    - Valid Redirect URIs: the url of your dev. environment or * for the time being
